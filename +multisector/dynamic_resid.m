...
residual(6) = lhs - rhs;
lhs = y(9);
rhs = y(10)*params(1)*2*T(8)*(params(10)*y(20)*params(9)+params(12)*y(22)*params(11))+y(10)*params(2);
residual(7) = lhs - rhs;
lhs = y(8);
rhs = (-params(8))*(y(24)-y(25));
residual(8) = lhs - rhs;
lhs = y(17);
rhs = T(9)+params(8)*(y(24)*(1-params(4)-params(3))+params(3)*y(26));
residual(9) = lhs - rhs;
lhs = y(19);
rhs = T(9)+params(8)*y(26);
residual(10) = lhs - rhs;
lhs = y(18);
rhs = log(y(7))-params(6)/2*y(6)^2+params(8)*(y(25)*(1-y(9))+y(9)*y(24));
residual(11) = lhs - rhs;
lhs = y(11);
rhs = y(9)*y(12);
residual(12) = lhs - rhs;
