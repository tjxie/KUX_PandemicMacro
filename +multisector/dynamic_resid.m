...
residual = zeros(19, 1);
lhs = T(2)*1/y(7)*T(3);
rhs = params(6)/params(7)*y(6)+params(7)*params(1)*y(10)*y(8)*params(9)/T(4);
residual(1) = lhs - rhs;
lhs = y(22);
rhs = y(21)/(steady_state(16))-1;
residual(2) = lhs - rhs;
lhs = 1/y(7)*T(5)*T(6);
rhs = params(6)/params(7)*y(6)+params(7)*params(1)*y(10)*y(8)*params(11)/T(4);
residual(3) = lhs - rhs;
lhs = y(24);
...
residual(6) = lhs - rhs;
lhs = y(9);
rhs = y(10)*params(1)*T(8)*(y(21)*params(9)+y(23)*params(11))+y(10)*params(2);
residual(7) = lhs - rhs;
lhs = y(8);
...
residual(18) = lhs - rhs;
lhs = y(16);
rhs = (params(7)*(y(10)+y(13))/T(4)+(y(21)+y(23))*y(12))/T(8)-1;
residual(19) = lhs - rhs;
