...
% Steady state generated by Dynare preprocessor
    ...
    ys_(14)=(log(ys_(2))-params(6)/2*ys_(1)^2)/(1-params(8));
    ys_(15)=ys_(14);
    ys_(13)=(log(ys_(2))-params(6)/2*ys_(1)^2+ys_(15)*params(8)*params(3))/(1-params(8)*(1-params(4)-params(3)));
    ys_(3)=params(8)*(ys_(14)-ys_(13));
    ys_(7)=1;
