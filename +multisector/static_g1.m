...
g1(7,4)=1;
g1(7,5)=(-(params(2)+params(1)*2*T(8)*(params(10)*y(16)*params(9)+params(12)*y(18)*params(11))));
g1(7,16)=(-(y(5)*params(1)*2*T(8)*params(10)*params(9)));
g1(7,18)=(-(y(5)*params(1)*2*T(8)*params(12)*params(11)));
g1(8,3)=1;
g1(8,12)=params(8);
g1(8,13)=(-params(8));
